...
NebulaSEO is pre-1.0. Security fixes are applied to the `main` branch and released in
...
1. Go to the [Security tab](https://github.com/Vmnebula/NebulaSeo/security).
